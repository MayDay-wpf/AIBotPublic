...
namespace aibotPro.Interface
{
    public interface ISystemService
    {
        ...
        List<CollectionModelDto> GetMyCollectionModel(string account); //获取用户收藏的AI模型
        bool UpdateMyCollectionModel(string account, string modelNames); //更新用户收藏的AI模型
        ...
        Task<string>
            UploadFileChunkAsync(IFormFile file, int chunkNumber, string fileName, string filePathhead); //上传文件分片
