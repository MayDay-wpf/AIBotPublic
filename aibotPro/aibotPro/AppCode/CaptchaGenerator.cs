    ...
    public class CaptchaGenerator
    {
        ...
        public static string CreateCaptchaImageBase64(string captchaCode)
        {
            ...
            using (var image = new Image<Rgba32>(width, height))
            {
                ...
                {
                    // 添加渐变背景
                    ctx.Fill(new LinearGradientBrush(new PointF(0, 0), new PointF(width, height), GradientRepetitionMode.None, new ColorStop(0, Color.FromRgb(200, 200, 255)), new ColorStop(1, Color.FromRgb(255, 200, 200))));

                    // 使用彩色文本
                    var textColor = Color.FromRgb((byte)Random.Shared.Next(256), (byte)Random.Shared.Next(256), (byte)Random.Shared.Next(256));
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        ...
                        var lineColor = Color.FromRgb((byte)Random.Shared.Next(256), (byte)Random.Shared.Next(256), (byte)Random.Shared.Next(256));
                    ...
                    for (int i = 0; i < 300; i++)
                    {
                        ...
                        var dotColor = Color.FromRgb((byte)Random.Shared.Next(256), (byte)Random.Shared.Next(256), (byte)Random.Shared.Next(256));
                        image[x, y] = dotColor;
                    }
                });
