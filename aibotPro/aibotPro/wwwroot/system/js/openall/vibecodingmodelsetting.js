$(function () {
    ...
    $("#vibecodingmodel_aisystem_nav").addClass('active');
    getVibeCodingModelSetting();
});
...
function saveVibeCodingModelSetting() {
    var vibeCodingModels = [];
    ...
    if (issave) {
        ...
        $.ajax({
            type: 'POST',
            url: '/OpenAll/SaveVibeCodingModelSetting',
            dataType: 'json',
            data: {
                vibeCodingModel: JSON.stringify(vibeCodingModels)
            },
...
function getVibeCodingModelSetting() {
    //发起请求
    $.ajax({
        type: 'Post',
        url: '/OpenAll/GetVibeCodingModelSetting',
        success: function (res) {
            if (res.success) {
                var data = res.data;
                if (data == null)
